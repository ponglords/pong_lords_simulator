...
describe RankingCalculator do
  describe "#initialize" do
    ...
    context "the player won" do
      ...
      it "assigns the correct outcome" do
        @calculator = RankingCalculator.new(double(player: player), opponent, true)
    ...
    context "the player lost" do
      ...
      it "assigns the correct outcome" do
        @calculator = RankingCalculator.new(double(player: player), opponent, false)
  ...
  describe "#update_ranking" do
    let(:opponent) { double(ranking: 100) }
    ...
    context "the player just turned pro" do
      let(:opponent) { stub_model(Player, ranking: Player::PRO_RANKING) }
